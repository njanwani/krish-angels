...
class Grab:
    ...
    def step(self, t, ready, armed):
        ...
        if self.mode == Grab.Mode.START and ready:
            ...
            self.t0 = t
        elif self.mode == Grab.Mode.TO_OBJ and armed and t - self.t0 > 3.0:
            self.mode = Grab.Mode.GRAB
            self.t0 = t
        elif self.mode == Grab.Mode.GRAB and armed and t - self.t0 > 3.0:
            self.done = True
...
class Drop:
    ...
    def step(self, t, ready, armed):
        ...
        if self.mode == Drop.Mode.START and ready:
            ...
            self.t0 = t
        elif self.mode == Drop.Mode.TO_POS and armed and t - self.t0 > 3.0:
            self.mode = Drop.Mode.DROP
            self.t0 = t
        elif self.mode == Drop.Mode.DROP and armed and t - self.t0 > 3.0:
            self.done = True
...
class Strike:
    ...
    def step(self, t, ready, armed):
        ...
        if self.mode == Strike.Mode.START and ready:
            ...
            self.t0 = t
        elif self.mode == Strike.Mode.TO_POS and armed and t - self.t0 > 3.0:
            self.mode = Strike.Mode.STRIKE
            self.t0 = t
        elif self.mode == Strike.Mode.STRIKE and armed and t - self.t0 > 3.0:
            self.done = True
...
class Move:
    ...
    def step(self, t, ready, armed):
        ...
        if self.mode == Move.Mode.START and ready:
            ...
            self.t0 = t
        elif self.mode == Move.Mode.TO_POS and armed and t - self.t0 > 3.0:
            self.mode = Move.Mode.STOP
            self.t0 = t
        elif self.mode == Move.Mode.STOP and t - self.t0 > 3.0:
            self.done = True
...
class Wait:
    ...
    def step(self, t, ready, armed):
        ...
        if self.mode == Wait.Mode.START and ready:
            ...
            self.t0 = t
        elif self.mode == Wait.Mode.STOP and t - self.t0 > 3.0:
            self.done = True
